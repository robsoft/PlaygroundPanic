...
sub InitAttractScreen()
  ...
  L2Text(1, 3, "      FROM ROBSOFT 2025", BANK_FONT, 0)

  L2Text(1,7, "  AVOID ALL OTHER KIDS UNTIL", BANK_FONT, 0)
  L2Text(1,8, "       BREAK-TIME ENDS.", BANK_FONT, 0)
  L2Text(1,10, "MILK HELPS PASS THE TIME, BUT", BANK_FONT, 0)
  L2Text(1,11, "DONT LEAVE IT TOO LONG OR THE", BANK_FONT, 0)
  ...
  L2Text(1,22, "VER 1.0E", BANK_FONT, 0)
